...
function showPosition(position) {
    ...
    +latlon+"&zoom=14&size=400x300&key=AIzaSyCngK4evHSlY6c-G81-feLHpE7V-HaiSSU";
...
<% 
    ...
    out.println("<form action='MapServlet' method='get'>");
	...
	out.println("<button type='submit' class='btn btn-outline-primary my-2 my-sm-0'>Raise a Request</button></a>");    
	out.println("</form>");    
%>
</html>
